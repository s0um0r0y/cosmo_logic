...
'''
Coding methodology in Robotics
There mainly two parts in robotic arm
1. the Arm 2. the gripper

One robot can have many grippers.
to accomodate those a simple logic is applied here

A second object of Gripper

now if a robot have two grippers then we can use list or directionary or class values
to directly command those. [ UNDER PROGRESS ]
